...
//store a list of reverse color names
var reverseNames = {};
 ...
 * effect, instead simply store/register plugins via plain JavaScript objects.
	...
	helpers.extend(Chart.prototype, /** @lends Chart */ {
		...
		construct: function(item, config) {
			...
			if (!context || !canvas) {
				...
				console.error("Failed to store chart: can't acquire context from the given item");
				return;
			}
...
module.exports = function() {
	...
	// Occupy the global variable of Chart, and store a simple base class
 ...
 * to store the lookup table. The table ALWAYS contains at least two items: min and max.
 *
